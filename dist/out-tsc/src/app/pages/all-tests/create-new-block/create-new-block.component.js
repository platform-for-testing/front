...
var CreateNewBlockComponent = /** @class */ (function () {
    ...
    CreateNewBlockComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: './create-new-block.component.html',
            styleUrls: ['./create-new-block.component.scss']
        }),
        __metadata("design:paramtypes", [])
    ], CreateNewBlockComponent);
    return CreateNewBlockComponent;
}());
exports.CreateNewBlockComponent = CreateNewBlockComponent;
